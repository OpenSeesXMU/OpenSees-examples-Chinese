...
//	x0 = passedMean + passedStdv*sqrt(pi) / sqrt(3.0*pi+4.0);
	...
	u = 2.0 * passedStdv / sqrt(4.0 - pi);       // Quan and Michele 2009 May 21
	x0 = passedMean - passedStdv*sqrt(pi) / sqrt(4.0 - pi);
...
double ShiftedRayleighRV::getParameter3()  {cout<<"No such parameter in r.v. #"<<tag<<endl; return 0.0;}
double ShiftedRayleighRV::getParameter4()  {cout<<"No such parameter in r.v. #"<<tag<<endl; return 0.0;}
