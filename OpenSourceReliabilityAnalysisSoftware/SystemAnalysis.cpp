...
SystemAnalysis::analyze(void)
{
	...
	cout << "System Reliability Analysis is running ... " << endl;
	...
	outputFile << "#  Upper probability bound: ........................... " 
		...
		<< "  #" << endl;
	outputFile << "#                                                                     #" << endl;
	outputFile << "#  Warning: All permutations of the limit-state functions should      #" << endl;
	outputFile << "#           be checked. Currently, this is not done automatically.    #" << endl;
	outputFile << "#           The user is therefore advised to do this manually.        #" << endl;
	outputFile << "#           Contact the developer for further details/plans.          #" << endl;
	outputFile << "#                                                                     #" << endl;
	...
	cout << "System reliability analysis completed." <<endl;
