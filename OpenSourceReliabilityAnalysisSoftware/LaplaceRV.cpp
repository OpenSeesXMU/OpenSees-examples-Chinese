...
double LaplaceRV::getParameter3()  {cout<<"No such parameter in r.v. #"<<tag<<endl; return 0.0;}
double LaplaceRV::getParameter4()  {cout<<"No such parameter in r.v. #"<<tag<<endl; return 0.0;}
