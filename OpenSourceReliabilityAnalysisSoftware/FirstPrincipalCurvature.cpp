...
//	opserr<<"last_u    "<<last_u<<endl;
//	opserr<<"secondLast_u  "<<secondLast_u<<endl;
//	opserr<<"principalAxes"<<principalAxes<<endl;
    ...
    for ( int m=0; m<principalAxes.Size(); m++ ) {
        resultsOutputFile<<principalAxes(m)<<endl;
	}
    ...
    resultsOutputFile1<<curvatures(0)<<endl;
