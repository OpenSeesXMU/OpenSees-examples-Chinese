...
:RandomVariable(passedTag, RANDOM_VARIABLE_exponential)
{
	...
	cout << "WARNING: This type of random variable is not uniquely defined by mean and stdv." << endl;
}
ExponentialRV::ExponentialRV(int passedTag, 
...
double ExponentialRV::getParameter2()  {cout<<"No such parameter in r.v. #"<<tag<<endl; return 0.0;}
double ExponentialRV::getParameter3()  {cout<<"No such parameter in r.v. #"<<tag<<endl; return 0.0;}
double ExponentialRV::getParameter4()  {cout<<"No such parameter in r.v. #"<<tag<<endl; return 0.0;}
