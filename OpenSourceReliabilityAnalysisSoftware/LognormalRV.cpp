...
LognormalRV::getInverseCDFvalue(double probValue)
{
	if ( probValue > 1.0 || probValue < 0.0) {
		cout << "Invalid probability value input to inverse CDF function" << endl;
		return 0.0;
	}
	else {
		static NormalRV aStandardNormalRV( 1, 0.0, 1.0, 0.0);
...
double LognormalRV::getParameter3()  {cout<<"No such parameter in r.v. #"<<tag<<endl; return 0.0;}

double LognormalRV::getParameter4()  {cout<<"No such parameter in r.v. #"<<tag<<endl; return 0.0;}
