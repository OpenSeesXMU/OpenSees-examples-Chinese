...
FORMAnalysis::analyze(void)
{
	...
	cout << "FORM Analysis is running ... " << endl;
	...
	if (aStdNormRV==0) {
		cout << "FORMAnalysis::analyze() - out of memory while instantiating internal objects." << endl;
		return -1;
	}
	...
	for (lsf=1; lsf<=numLsf; lsf++ ) {
		...
		if (theLimitStateFunction == 0) {
			cout << "FORMAnalysis::analyze() - could not find" << endl
		...
		if (theFindDesignPointAlgorithm->findDesignPoint(theReliabilityDomain) < 0){
			cout << "FORMAnalysis::analyze() - failed while finding the" << endl
			...
			outputFile << "#                                                                     #" << endl;
			outputFile << "#  No convergence!                                                    #" << endl;
			outputFile << "#                                                                     #" << endl;
			...
			double normOfGradientInDesignPoint = (theFindDesignPointAlgorithm->getGradientInStandardNormalSpace()).Norm();
...
//				kappa = kappa * (1.0/kappa.Norm());
			...
			outputFile << "#  Limit-state function value at end point: ........... " 
				...
				<< "  #" << endl;
//  Quan and Michele  Oct 2005 --
			outputFile << "#  Norm of gradient at design point ................... " 
				<<setiosflags(ios::left)<<setprecision(5)<<setw(12)<<normOfGradientInDesignPoint 
				<< "  #" << endl;
...
//				}
			...
			cout << "Done analyzing limit-state function " << lsf << ", beta=" << beta << endl;
		}
	...
	cout << "FORMAnalysis completed." << endl;
