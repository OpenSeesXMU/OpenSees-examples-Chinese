...
runMonteCarloResponseAnalysis  -outPutFile  m.out -maxNum 3000 -print 1
#runSubsetSimulationAnalysis  -outPutFile  m.out -SamplingType HMC -NumSeedSamples 1 -print 1
#runSubsetSimulationAnalysis  -outPutFile  m.out -SamplingType MH 1 -NumSeedSamples 3000 -print 1