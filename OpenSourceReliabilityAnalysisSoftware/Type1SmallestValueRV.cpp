...
double Type1SmallestValueRV::getParameter3()  {cout<<"No such parameter in r.v. #"<<tag<<endl; return 0.0;}
double Type1SmallestValueRV::getParameter4()  {cout<<"No such parameter in r.v. #"<<tag<<endl; return 0.0;}
