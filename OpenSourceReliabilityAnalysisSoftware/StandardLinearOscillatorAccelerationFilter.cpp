...
StandardLinearOscillatorAccelerationFilter::getMaxAmplitude()
{
	...
	cout << "ERROR: The getMaxAmplitude() method is not implemented for acceleration filter." << endl;
...
StandardLinearOscillatorAccelerationFilter::getTimeOfMaxAmplitude()
{
	...
	cout << "ERROR: The getTimeOfMaxAmplitude() method is not implemented for acceleration filter." << endl;
