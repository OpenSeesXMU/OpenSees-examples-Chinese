...
FOSMAnalysis::analyze(void)
{
	...
	cout << "FOSM Analysis is running ... " << endl;
	...
	for (i=1; i<=nrv; i++)
	{
		...
		if (aRandomVariable == 0) {
			cout << "FOSMAnalysis::analyze() -- Could not find" << endl
	...
	if (result < 0) {
		cout << "FOSMAnalysis::analyze() - " << endl
	...
	if (result < 0) {
		cout << "FOSMAnalysis::analyze() -- could not" << endl
			<< " compute gradients of the limit-state function. " << endl;
		return -1;
	}
	...
	for (lsf=1; lsf<=numLsf; lsf++ ) {
		...
		outputFile << "#  Estimated standard deviation: ...................... " 
			...
			<< "  #" << endl;
		outputFile << "#                                                                     #" << endl;
		outputFile << "#      R.v.         Importance measure (dgdx*stdv)                    #" << endl;
	...
	outputFile << "#######################################################################" << endl;
	outputFile << "#  RESPONSE CORRELATION COEFFICIENTS                                  #" << endl;
	outputFile << "#                                                                     #" << endl;
	if (numLsf <=1) {
		outputFile << "#  Only one limit-state function!                                     #" << endl;
	}
	else {
		outputFile << "#   gFun   gFun     Correlation                                       #" << endl;
...
//				outputFile.setf(ios::scientific, ios::floatfield);
	...
	cout << "FOSMAnalysis completed." << endl;
